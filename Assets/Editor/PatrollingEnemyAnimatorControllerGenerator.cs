...
public class PatrollingEnemyAnimatorControllerGenerator
{
    [MenuItem("Tools/Generate Patrolling Enemy Animator Controller")]
    public static void GeneratePatrollingEnemyAnimatorController()
    {
        // Create the animator controller
        var controller = AnimatorController.CreateAnimatorControllerAtPath(
            "Assets/Sprites/Animations/PatrollingEnemy/PatrollingEnemyAnimatorController.controller");
        ...
        var walkDown = AssetDatabase.LoadAssetAtPath<AnimationClip>("Assets/Sprites/Animations/PatrollingEnemy/PatrollingEnemyGoingDown.anim");
        var walkUp = AssetDatabase.LoadAssetAtPath<AnimationClip>("Assets/Sprites/Animations/PatrollingEnemy/PatrollingEnemyGoingUp.anim");
        var walkHorizontal = AssetDatabase.LoadAssetAtPath<AnimationClip>("Assets/Sprites/Animations/PatrollingEnemy/PatrollingEnemyGoingHorizontally.anim");
        ...
        Debug.Log("Patrolling Enemy Animator Controller created successfully!");
    }
}
